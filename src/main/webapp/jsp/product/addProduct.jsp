...
<div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <form action="#">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <select id="category" name="category" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
    ...
    <option value="Photography & Cameras">Photography & Cameras</option>
    <option value="Wearable Technology">Wearable Technology</option>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="image-url" id="image-url" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Image URL" required="">
                </div>
